...
xepOnline.Formatter = {
	...
	getFOContainer: function(options) {
        ...
        //Kevin Hack move base to new root container, do not need it here
    	...
    	//container.attr('base', xepOnline.Formatter.getBase());
	...
	xsl_stylesheet_declaration: '<?xml-stylesheet type="text/xsl" href="http://xep.cloudformatter.com/Doc/XSL/xeponline-fo-translate-beta.xsl"?>',
	...
	*/
	...
	Format: function(ElementID, options) {
	    ...
	    var printcopy = xepOnline.Formatter.cleanTags($(xepOnline.Formatter.__container)[0].outerHTML);
